...
class FSDPCheckpoint:
    ...
    def fsdp_save_ckpt(
        ...
        if ema_model is not None:
            with FSDP.state_dict_type(
                ...
                FSDP._save_to_state_dict(ema_state_dict, os.path.join(save_path, "ema"))
        ...
        with FSDP.state_dict_type(
            ...
            FSDP._save_to_state_dict(model_state_dict, os.path.join(save_path, "model"))
    ...
    def try_load_ckpt(resume_from, logger, model, ema_model=None, resume_from_ema=False):
        if resume_from is not None and os.path.exists(resume_from):
            ...
            #     model_state_dict = FSDP.load_state_dict(model, model_state_dict_path)
            ...
            ## 上面保存使用SHARDED_STATE_DICT, 这里必须使用FSDP.load_state_dict而不是load_file
            ...
            if ema_model is not None:
                ...
                #     ema_state_dict = FSDP.load_state_dict(ema_model, ema_state_dict_path)
